...
<html>
    ...
    <body>
        <div class="content_contact_us">
            <p style="text-align: center; font-size: 50px; color: #A3080C;">Contact Information</p>
            <div class="contact_information1">
                <p style="text-align: center; font-size: 25px; font-weight: bold; color: #A3080C;">Kentucky Fried Chicken</p>
                <div class="contact_details">
                    <label>Mobile: 1-800-CALL-KFC &nbsp&nbsp&nbsp&nbsp&nbsp</label>
                </div>
            </div>
